...
function get_todos() {
    ...
    var todos = new Array;
    /*this pulls the task that was saved in the web brower memory*/
    var todos_str = localStorage.getItem('todo');
    /*If the input is not null then JSON.parse will
    communicate with the web brower to make the task a JavaScript object.*/
    if (todos_str !== null) {
...
/* This tells the brower how to display the todo
